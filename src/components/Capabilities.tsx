...
const Capabilities = () => {
  ...
  const infrastructure = [
    { spec: "CNC Turning Centers", icon: <Zap size={20} /> },
    { spec: "BFW VMC (3-axis)",  icon: <Zap size={20} /> },
    { spec: "Traub Machines",  icon: <Zap size={20} /> },
    { spec: "Centerless & Belt Grinders",  icon: <Zap size={20} /> },
    { spec: "Quality Lab",  icon: <Shield size={20} /> },
    { spec: "DG Backup",  icon: <Zap size={20} /> }
  ];
